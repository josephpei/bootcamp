...
def article(request, slug):
    ...
    return render(request, 'articles/article.html', {'nbar': 'articles', 'article': article})
...
def write(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if status in [Article.DRAFT, Article.PUBLISHED]:
        ...
        form = ArticleForm()
    return render(request, 'articles/write.html', {'nbar': 'articles', 'form': form})
...
def drafts(request):
    ...
    return render(request, 'articles/drafts.html', {'nbar': 'articles', 'drafts': drafts})
...
def edit(request, id):
    ...
    return render(request, 'articles/edit.html', {'nbar': 'articles', 'form': form})
